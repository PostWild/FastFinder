...
async def rename(bot,update):
	...
	await update.message.reply_text("✍️ Please Enter New File Name...",	
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @TeamYourX ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You TeamYourX ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add Me To Your Groups ➕', url=f'http://t.me/FastFinderBot?startgroup=true')
        ], [
        ...
        await query.answer('♥️ Thank You TeamYourX ♥️')
    ...
    #     text = f"""\n\n**Please tell, what should i do with this file.?**\n"""
    #     buttons = [[ InlineKeyboardButton("✍️ Renaming 🐧", callback_data="requireauth") ],
    #                        [ InlineKeyboardButton("🙅 Close 🙈", callback_data="cancel") ]]
    #     reply_markup = InlineKeyboardMarkup(buttons)
    #     await query.message.edit_text(
    #                 text=text,
...
async def auto_filter(client, msg, spoll=False):
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                await client.send_message(req_channel,f"-⚡ #Requested 🦅-\n\n🎬**Name** :`{search}`\n🦹**Requested By**: {message.from_user.first_name}\n🆔**USER ID**:{user_id}\n",
    ...
    if imdb:
        ...
        cap = f"🦉 Your Search Result Is Here 🦅 \n\n🚀 {search} ⚡"
